...
const relayLocales: Readonly<Record<ConnectorLocale, RelayLocaleText>> = {
  ko: {
    ...
    details: "상세",
    endReason: "종료 사유",
    releaseUpdateAvailable: "온라인 Connector를 조회해 서버별 전용 업데이트 스레드 한 곳에 이 release 적용을 요청할 수 있습니다.",
  ...
  en: {
    ...
    releaseUpdateAvailable: "Discover online connectors and apply this release through one dedicated update thread per server.",
  ...
  zh: {
    ...
    details: "详情",
    endReason: "结束原因",
    releaseUpdateAvailable: "发现在线 Connector，并通过每台服务器的一个专用更新线程应用此版本。",
  ...
  ja: {
    ...
    details: "詳細",
    endReason: "終了理由",
    releaseUpdateAvailable: "オンライン Connector を検出し、各サーバー専用の更新スレッド1つからこの release を適用します。",
